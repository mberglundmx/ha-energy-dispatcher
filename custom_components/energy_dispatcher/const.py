...
DEFAULT_SOLAR_SUSTAIN_MINUTES = 3
...
ATTR_SOLAR_ELIGIBLE_SINCE = "solar_eligible_since"
ATTR_SOLAR_SUSTAIN_REMAINING = "solar_sustain_remaining_seconds"
...
REASON_GRID_EXPENSIVE = "grid_expensive"
